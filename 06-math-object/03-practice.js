...
Write a program that generates 3 random numbrers between 1 and 10 (both inclusive)
Calculate the greatest and the smallest numbers and print their absolute differnce. 
...
PSEUDO CODE ==> step by step about how you explain your approach 
1. Generate 3 random numbers
2. Find max and min numbers among the random numbers
3. Calculate and output max - min 
*/

//1. Generate 3 random numbers from the range 1 to 10 (inclusive)
...
console.log(`Random numbers are = ${r1}, ${r2}, ${3}`)
