...
console.log(num1, num2) // more concise --> better
...
if(char2Code >= 48 && char2Code <= 57) console.log(`"${char2}" is a digit`); //char2 >= 48 && char2 <=57
...
if (char3Code >= 65 && char3Code <=90) return console.log(`"${char3}" is a Uppercase letter.`); 
else if (char3Code >= 97 && char3Code <= 122) return console.log(`"${char3}" is a lowercase letter.`); 
...
*/
let char4 = '&'; 
let char4Code = char4.charCodeAt(0);  // 33 - 47 && 58 - 64 && 123- 126

if (char4Code >= 48 && char4Code <= 57 || char4Code >= 65 && char4Code <=90 || char4Code >= 97 && char4Code <= 122) return console.log(`"${char4}" is not a special character.`); 
else console.log(`"${char4}" is a special character.`); 
